...
let pag = document.querySelector(".container .pagina .grupos-list")
let pag1 = document.querySelector(".container .pagina .grupos-list .group-list")
let globalIdGrupo = ""
...
form_group.addEventListener("submit", (e)=> {
    pag1.innerHTML = "" //limpar o historico dos grupos
    e.preventDefault();
    axios({
        method: "POST",
        url: "https://server-json-lms.herokuapp.com/grupos",
